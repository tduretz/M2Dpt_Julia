        ...
        if WENO5 == 0 % upwind
            ...
            for j=1:ny+2
                for i=1:nx+2
                    ...
                    if bc(ie,je)==1 && bc(ie+1,je)==-1 && i==1
                        phiex(i,j) = 2*valW - phi1t(i-1+1,j-1);
                    elseif bc(ie,je)==2 && bc(ie-1,je)==-1 && i==nx+2
            ...
            [phxm1,phxp1,c,d] = weno5_v3_free(phi1t, dx, dy , 1, 0, BC, valW, valE, valS, valN, valX, bc);
        end
        ...
        if WENO5 == 0 % upwind
            ...
            for j=1:ny+2
                for i=1:nx+2
                    ...
                    if bc(ie,je)==3 && bc(ie,je+1)==-1 && j==1
                         phiey(i,j) = 2*valS - phi1t(i-1,j-1+1);
                    elseif bc(ie,je)==4 && bc(ie,je-1)==-1 && j==ny+2
            ...
            [a,b,phym1,phyp1] = weno5_v3_free(phi1t, dx, dy , 0, 1, BC, valW, valE, valS, valN, valX, bc);
        end
