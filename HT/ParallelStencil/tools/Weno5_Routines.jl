...
@parallel_indices (ix,iy,iz)function VxPlusMinus(Vxm::Data.Array, Vxp::Data.Array, Vx::Data.Array, nx::Int, ny::Int, nz::Int)
...
@parallel_indices (ix,iy,iz) function VyPlusMinus(Vym::Data.Array, Vyp::Data.Array, Vy::Data.Array, nx::Int, ny::Int, nz::Int)
...
@parallel_indices (ix,iy,iz) function VzPlusMinus(Vzm::Data.Array, Vzp::Data.Array, Vz::Data.Array, nx::Int, ny::Int, nz::Int)
 ...
 @parallel_indices (ix,iy,iz) function dFdx_Weno5(dFdxi::Data.Array, V1::Data.Array, V2::Data.Array, V3::Data.Array, V4::Data.Array, V5::Data.Array, nx::Int, ny::Int, nz::Int)
...
@parallel function Gradients_minus_x_Weno5(v1::Data.Array, v2::Data.Array, v3::Data.Array, v4::Data.Array, v5::Data.Array, Fc_exxx::Data.Array, dx::Data.Number, dy::Data.Number, dz::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(v1) = 1.0/dx*( @in_xxx_xm2(Fc_exxx) -  @in_xxx_xm3(Fc_exxx) );
        @all(v2) = 1.0/dx*( @in_xxx_xm1(Fc_exxx) -  @in_xxx_xm2(Fc_exxx) );
        @all(v3) = 1.0/dx*(     @in_xxx(Fc_exxx) -  @in_xxx_xm1(Fc_exxx) );
        @all(v4) = 1.0/dx*( @in_xxx_xp1(Fc_exxx) -      @in_xxx(Fc_exxx) );
        @all(v5) = 1.0/dx*( @in_xxx_xp2(Fc_exxx) -  @in_xxx_xp1(Fc_exxx) );
return
end

@parallel function Gradients_plus_x_Weno5(v1::Data.Array, v2::Data.Array, v3::Data.Array, v4::Data.Array, v5::Data.Array, Fc_exxx::Data.Array, dx::Data.Number, dy::Data.Number, dz::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(v1) = 1.0/dx*( @in_xxx_xp3(Fc_exxx) -  @in_xxx_xp2(Fc_exxx) );
        @all(v2) = 1.0/dx*( @in_xxx_xp2(Fc_exxx) -  @in_xxx_xp1(Fc_exxx) );
        @all(v3) = 1.0/dx*( @in_xxx_xp1(Fc_exxx) -      @in_xxx(Fc_exxx) );
        @all(v4) = 1.0/dx*(     @in_xxx(Fc_exxx) -  @in_xxx_xm1(Fc_exxx) );
        @all(v5) = 1.0/dx*( @in_xxx_xm1(Fc_exxx) -  @in_xxx_xm2(Fc_exxx) );
return
end

@parallel function Gradients_minus_y_Weno5(v1::Data.Array, v2::Data.Array, v3::Data.Array, v4::Data.Array, v5::Data.Array, Fc_exxx::Data.Array, dx::Data.Number, dy::Data.Number, dz::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(v1) = 1.0/dy*( @in_xxx_ym2(Fc_exxx) -  @in_xxx_ym3(Fc_exxx) );
        @all(v2) = 1.0/dy*( @in_xxx_ym1(Fc_exxx) -  @in_xxx_ym2(Fc_exxx) );
        @all(v3) = 1.0/dy*(     @in_xxx(Fc_exxx) -  @in_xxx_ym1(Fc_exxx) );
        @all(v4) = 1.0/dy*( @in_xxx_yp1(Fc_exxx) -      @in_xxx(Fc_exxx) );
        @all(v5) = 1.0/dy*( @in_xxx_yp2(Fc_exxx) -  @in_xxx_yp1(Fc_exxx) );
return
end

@parallel function Gradients_plus_y_Weno5(v1::Data.Array, v2::Data.Array, v3::Data.Array, v4::Data.Array, v5::Data.Array, Fc_exxx::Data.Array, dx::Data.Number, dy::Data.Number, dz::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(v1) = 1.0/dy*( @in_xxx_yp3(Fc_exxx) -  @in_xxx_yp2(Fc_exxx) );
        @all(v2) = 1.0/dy*( @in_xxx_yp2(Fc_exxx) -  @in_xxx_yp1(Fc_exxx) );
        @all(v3) = 1.0/dy*( @in_xxx_yp1(Fc_exxx) -      @in_xxx(Fc_exxx) );
        @all(v4) = 1.0/dy*(     @in_xxx(Fc_exxx) -  @in_xxx_ym1(Fc_exxx) );
        @all(v5) = 1.0/dy*( @in_xxx_ym1(Fc_exxx) -  @in_xxx_ym2(Fc_exxx) );
return
end

@parallel function Gradients_minus_z_Weno5(v1::Data.Array, v2::Data.Array, v3::Data.Array, v4::Data.Array, v5::Data.Array, Fc_exxx::Data.Array, dx::Data.Number, dy::Data.Number, dz::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(v1) = 1.0/dz*( @in_xxx_zm2(Fc_exxx) -  @in_xxx_zm3(Fc_exxx) );
        @all(v2) = 1.0/dz*( @in_xxx_zm1(Fc_exxx) -  @in_xxx_zm2(Fc_exxx) );
        @all(v3) = 1.0/dz*(     @in_xxx(Fc_exxx) -  @in_xxx_zm1(Fc_exxx) );
        @all(v4) = 1.0/dz*( @in_xxx_zp1(Fc_exxx) -      @in_xxx(Fc_exxx) );
        @all(v5) = 1.0/dz*( @in_xxx_zp2(Fc_exxx) -  @in_xxx_zp1(Fc_exxx) );
return
end

@parallel function Gradients_plus_z_Weno5(v1::Data.Array, v2::Data.Array, v3::Data.Array, v4::Data.Array, v5::Data.Array, Fc_exxx::Data.Array, dx::Data.Number, dy::Data.Number, dz::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(v1) = 1.0/dz*( @in_xxx_zp3(Fc_exxx) -  @in_xxx_zp2(Fc_exxx) );
        @all(v2) = 1.0/dz*( @in_xxx_zp2(Fc_exxx) -  @in_xxx_zp1(Fc_exxx) );
        @all(v3) = 1.0/dz*( @in_xxx_zp1(Fc_exxx) -      @in_xxx(Fc_exxx) );
        @all(v4) = 1.0/dz*(     @in_xxx(Fc_exxx) -  @in_xxx_zm1(Fc_exxx) );
        @all(v5) = 1.0/dz*( @in_xxx_zm1(Fc_exxx) -  @in_xxx_zm2(Fc_exxx) );
return
end

@parallel_indices (ix,iy,iz) function  Boundaries_x_Weno5( Fc_exxx::Data.Array, Fc::Data.Array, type_W::Int, val_W::Data.Number, type_E::Int, val_E::Data.Number, nx::Int, ny::Int, nz::Int )

        if (ix<=size(Fc_exxx,1)-6 && iy<=size(Fc_exxx,2)-6 && iz<=size(Fc_exxx,3)-6) Fc_exxx[ixiii,iyiii,iziii] = Fc[ix,iy,iz]; end
...
@parallel_indices (ix,iy,iz) function  Boundaries_y_Weno5( Fc_exxx::Data.Array, Fc::Data.Array, type_S::Int, val_S::Data.Number, type_N::Int, val_N::Data.Number, nx::Int, ny::Int, nz::Int )
...
@parallel_indices (ix,iy,iz) function  Boundaries_z_Weno5( Fc_exxx::Data.Array, Fc::Data.Array, type_B::Int, val_B::Data.Number, type_F::Int, val_F::Data.Number, nx::Int, ny::Int, nz::Int )
...
@parallel function  Advect(Fc::Data.Array, Vxp::Data.Array, dTdxm::Data.Array, Vxm::Data.Array, dTdxp::Data.Array, dt::Data.Number, nx::Int, ny::Int, nz::Int )

        @all(Fc) = @all(Fc) - dt*(@all(Vxp)*@all(dTdxm) + @all(Vxm)*@all(dTdxp));
return
end

@parallel function  TimeAveraging(Fc::Data.Array, Fold::Data.Array, order::Data.Number, nx::Int, ny::Int, nz::Int)

        @all(Fc) = (1.0/order)*@all(Fc) + (1.0-1.0/order)*@all(Fold);
return
end

@parallel function  ArrayEqualArray(F1::Data.Array, F2::Data.Array, nx::Int, ny::Int, nz::Int)

        @all(F1) = @all(F2);
return
end

@parallel function  InitialCondition(Tc::Data.Array, xc2::Data.Array, yc2::Data.Array, zc2::Data.Array, x0::Data.Number, y0::Data.Number, z0::Data.Number, sig2::Data.Number, nx::Int, ny::Int, nz::Int)
