...
@parallel function ComputeFlux(kx::Data.Array,ky::Data.Array,kz::Data.Array, A::Data.Array, qx::Data.Array, qy::Data.Array, qz::Data.Array,
    _dx::Data.Number, _dy::Data.Number, _dz::Data.Number, nx::Int, ny::Int, nz::Int)
...
@parallel function UpdateP(dampx::Data.Number, dtau::Data.Number, P::Data.Array, F::Data.Array, F0::Data.Array, nx::Int, ny::Int, nz::Int)
...
@parallel_indices (ix,iy,iz) function SetPressureBCs(Pc_ex::Data.Array, Pbot::Data.Number, Ptop::Data.Number, nx::Int, ny::Int, nz::Int)
...
dy       = Ly/Niy;
dz       = Lz/Niz;
dt       = min(dx,dy,dz)^2/4.1*1.0;
_dx = 1.0/dx; _dy = 1.0/dy; _dz = 1.0/dz; _dt = 1.0/dt;
@printf("Go go!!\n")
...
for it = it1:nt
    ...
    for iter = 0:nitmax
        @parallel cublocks cuthreads SetPressureBCs(Tc_ex, Tbot, Ttop, nx, ny, nz);
        @parallel cublocks cuthreads ComputeFlux(kx, ky, kz, Tc_ex, qx, qy, qz, _dx, _dy, _dz, nx, ny, nz);
        @parallel cublocks cuthreads UpdateT(_dt, dtauT, Tc_ex, Rt, Ft, qx, qy, qz, _dx, _dy, _dz, nx, ny, nz);
    ...
    for iter = 0:nitmax
        @parallel cublocks cuthreads SetPressureBCs(Pc_ex, Pbot, Ptop, nx, ny, nz);
        @parallel cublocks cuthreads ComputeFlux(kx, ky, kz, Pc_ex, qx, qy, qz, _dx, _dy, _dz, nx, ny, nz);
        @parallel cublocks cuthreads ResidualDiffusion(Rp, Ft, qx, qy, qz, _dx, _dy, _dz, nx, ny, nz);
        @parallel cublocks cuthreads UpdateP(dampx, dtauP, Pc_ex, Ft, Ft0, nx, ny, nz);
    ...
    if Advection == 1
        ...
        @parallel cublocks cuthreads VxPlusMinus(Vxm, Vxp, Vx, nx, ny, nz);
        Vym     =  @zeros(nx+0,ny+0,nz+0);
        Vyp     =  @zeros(nx+0,ny+0,nz+0);
        @parallel cublocks cuthreads VyPlusMinus(Vym, Vyp, Vy, nx, ny, nz);
        ...
        @parallel cublocks cuthreads ArrayEqualArray(Told, Tc, nx, ny, nz);
        for io=1:order
            @parallel cublocks cuthreads Boundaries_x_Weno5(Tc_exxx, Tc, BC_type_W, BC_val_W, BC_type_E, BC_val_E, nx, ny, nz);
            @parallel cublocks cuthreads Gradients_minus_x_Weno5(v1, v2, v3, v4, v5, Tc_exxx, dx, dy, dz, nx, ny, nz);
            @parallel cublocks cuthreads dFdx_Weno5(dTdxm, v1, v2, v3, v4, v5, nx, ny, nz);
            @parallel cublocks cuthreads Gradients_plus_x_Weno5(v1, v2, v3, v4, v5, Tc_exxx, dx, dy, dz, nx, ny, nz);
            @parallel cublocks cuthreads dFdx_Weno5(dTdxp, v1, v2, v3, v4, v5, nx, ny, nz);
            @parallel cublocks cuthreads Advect(Tc, Vxp, dTdxm, Vxm, dTdxp, dt, nx, ny, nz);
        end
        @parallel cublocks cuthreads TimeAveraging(Tc, Told, order, nx, ny, nz);

       # Advect in y direction
       @parallel cublocks cuthreads ArrayEqualArray(Told, Tc, nx, ny, nz);
       for io=1:order
           @parallel cublocks cuthreads Boundaries_y_Weno5(Tc_exxx, Tc, BC_type_S, BC_val_S, BC_type_N, BC_val_N, nx, ny, nz);
           @parallel cublocks cuthreads Gradients_minus_y_Weno5(v1, v2, v3, v4, v5, Tc_exxx, dx, dy, dz, nx, ny, nz);
           @parallel cublocks cuthreads dFdx_Weno5(dTdxm, v1, v2, v3, v4, v5, nx, ny, nz);
           @parallel cublocks cuthreads Gradients_plus_y_Weno5(v1, v2, v3, v4, v5, Tc_exxx, dx, dy, dz, nx, ny, nz);
           @parallel cublocks cuthreads dFdx_Weno5(dTdxp, v1, v2, v3, v4, v5, nx, ny, nz);
           @parallel cublocks cuthreads Advect(Tc, Vyp, dTdxm, Vym, dTdxp, dt, nx, ny, nz);
       end
       @parallel cublocks cuthreads TimeAveraging(Tc, Told, order, nx, ny, nz);
       ...
       @parallel cublocks cuthreads ArrayEqualArray(Told, Tc, nx, ny, nz);
       for io=1:order
           @parallel cublocks cuthreads Boundaries_z_Weno5(Tc_exxx, Tc, BC_type_B, BC_val_B, BC_type_F, BC_val_F, nx, ny, nz);
           @parallel cublocks cuthreads Gradients_minus_z_Weno5(v1, v2, v3, v4, v5, Tc_exxx, dx, dy, dz, nx, ny, nz);
           @parallel cublocks cuthreads dFdx_Weno5(dTdxm, v1, v2, v3, v4, v5, nx, ny, nz);
           @parallel cublocks cuthreads Gradients_plus_z_Weno5(v1, v2, v3, v4, v5, Tc_exxx, dx, dy, dz, nx, ny, nz);
           @parallel cublocks cuthreads dFdx_Weno5(dTdxp, v1, v2, v3, v4, v5, nx, ny, nz);
           @parallel cublocks cuthreads Advect(Tc, Vzp, dTdxm, Vzm, dTdxp, dt, nx, ny, nz);
       end
       @parallel cublocks cuthreads TimeAveraging(Tc, Told, order, nx, ny, nz);
